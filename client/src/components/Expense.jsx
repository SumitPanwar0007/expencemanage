...
const Expense = () => {
  ...
  return (
    <div className='mt-6'>
    <h1 className=" px-4 text-2xl">Expanse</h1>
    <br />
      ...
      {allTransaction.map((transection) => {
       ...
       const formattedDate = transactionDate.toISOString().split('T')[0]; 
          return (<>
            ...
            <div className="w-10/12 sm:w-[60vw]  h-16 flex flex-col  bg-[#484899]/[0.6] rounded-lg mx-2 py-2 ">
            <div className="w-full pl-8 text-xl"><p> {transection.description}</p> </div>
            <div className="flex justify-evenly text-sm pl-4 gap-2">
              <p className='text-[#991b1b] text-xl'> ₹{transection.amount}</p>
